        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">asdadasdadadadasdadawasfaf</p>
              {/* input */}
              <div className="grid grid-cols-1 mb:grid-cols-2 gap-6">
                ...
                <Input type="phone" placeholder="Numero de " />
              </div>
              {/* select */}
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="est">Desarrollador Web</SelectItem>
                    <SelectItem value="cst">Diseño UI/UX</SelectItem>
                    <SelectItem value="mst">Diseño Logo</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* textarea */}
