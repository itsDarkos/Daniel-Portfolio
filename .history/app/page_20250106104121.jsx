...
const Home = () => {
  ...
  const downloadPDF = async () => {
    ...
    try {
      console.log("Iniciando la solicitud de descarga...");
      const response = await fetch("/app/generate-pdf");
  
      // Verifica el estado de la respuesta
      if (!response.ok) {
        console.error("Error al generar el PDF, estado:", response.status);
      ...
      link.download = "portfolio.pdf"; // Nombre del archivo PDF
      link.click();
