...
import { SiTailwindcss, SiNextdotjs, SiCsharp, SiFramer } from "react-icons/si";
...
const experience = {
  ...
  description:
    "He tenido la oportunidad de trabajar en varios roles, adquiriendo experiencia tanto en diseño como en desarrollo. Desde crear interfaces de usuario intuitivas como UI/UX Designer hasta desarrollar sitios web dinámicos y responsivos como Front-End Developer, he perfeccionado mis habilidades en una variedad de tecnologías. Mi objetivo siempre es crear experiencias de usuario fluidas y impactantes, mientras continúo desafiándome y creciendo profesionalmente.",
  items: [
    {
      company: "MeritumDev",
      position: "DiseñadoUI/UX",
      duration: "2024",
    },
    {
      company: "MeritumDev",
...
const education = {
  ...
  title: "My Education",
  description:
    "I have experience working with a variety of technologies, including HTML, CSS, JavaScript, React, Node.js, Python, and Unity. I am always looking for new challenges and opportunities to learn and grow as a developer.",
  items: [
    {
