...
const experience = {
  ...
  description:
    "He tenido la oportunidad de trabajar en varios roles, adquiriendo experiencia tanto en diseño como en desarrollo. Desde crear interfaces de usuario intuitivas como Diseñador UI/UX hasta desarrollar sitios web dinámicos y responsivos como Desarrollador Front-End, he perfeccionado mis habilidades en una variedad de tecnologías. Mi objetivo siempre es crear experiencias de usuario fluidas y impactantes, mientras continúo desafiándome y creciendo profesionalmente.",
  items: [
    {
      company: "MeritumDev",
