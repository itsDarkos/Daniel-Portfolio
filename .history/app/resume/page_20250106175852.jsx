...
const skills = {
  ...
  description:
    "Me especializo en crear interfaces de usuario atractivas y eficientes utilizando una amplia gama de tecnologías modernas." <hr/> "Mi experiencia abarca tanto el desarrollo front-end como back-end, lo que me permite construir aplicaciones interactivas y responsivas de principio a fin.",
  skillList: [
    {
      icon: <FaHtml5 />,
      title: "HTML",
