...
const about = {
  title: "Sobre mí",
  description:
    "Mi objetivo siempre es crear experiencias de usuario fluidas y impactantes, mientras continúo desafiándome y creciendo profesionalmente.",
  info: [
    {
      fieldName: "Nombre",
...
const education = {
  ...
  items: [
    {
      institution: "MinTIC y Uninorte",
      degree: "Diplomado en Desarrollo de Software",
      duration: "2022",
    },
    {
      institution: "MinTIC y Uninorte",
      degree: "Diplomado De Desarrollo De Aplicaciones Web",
      duration: "2022",
    },
    {
    ...
    {
      institution: "Online Course Platform",
      degree: "Front EndWeb Development Bootcamp",
      duration: "2024",
    },
  ],
};
...
const skills = {
  ...
  description:
    "Me especializo en crear interfaces de usuario atractivas y eficientes utilizando una amplia gama de tecnologías modernas. Mi experiencia abarca tanto el desarrollo front-end como back-end, lo que me permite construir aplicaciones interactivas y responsivas de principio a fin.",
  skillList: [
    {
      icon: <FaHtml5 />,
      title: "HTML",
